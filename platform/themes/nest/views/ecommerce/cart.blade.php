...
<div class="mb-80 mt-50 section--shopping-cart">
    ...
    <form method="post" action="{{ route('public.cart.update') }}">
        ...
        <div class="row">
                                    ...
                                    @if ($product = $products->find($cartItem->id))
                                        <tr class="pt-30">
                                            ...
                                            <td class="product-des product-name">
                                                ...
                                                @endif
                                                <a  class="btn"  href="https://wa.me/{{ $product->store->phone }}?text={{ $product->name }} {{$product->price}} {{ $product->original_product->url }}"><i  style="font-size:15px; color:white; opacity: 1;" class="fa fa-whatsapp "></i> Commander</a>
            ...
            <!-- @if (Cart::instance('cart')->count() > 1000)
                <div class="col-lg-4">
