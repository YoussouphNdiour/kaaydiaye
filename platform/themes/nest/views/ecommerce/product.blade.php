                            ...
                            @if (EcommerceHelper::isCartEnabled())
                                ...
                                @if (EcommerceHelper::isQuickBuyButtonEnabled())
                                    <!-- <button class="button button-buy-now @if ($product->isOutOfStock()) btn-disabled @endif"
                                        ...
                                        <a  style="width:50%; background-color:#5A97FA;" href="https://wa.me/{{ $product->store->phone }}?text={{ $product->name }} {{$product->price}} https://wwww.kaaydiaye.sn{{$_SERVER['REQUEST_URI']}} "><i  style="font-size:26px; color:white; opacity: 1;" class="fa fa-whatsapp ">Whatsapp</i></a>
                                @endif
                            @endif
